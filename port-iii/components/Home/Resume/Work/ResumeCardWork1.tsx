...
const ResumeCardWork1 = ({Icon, role, date}: Props) => {
  return (
    <div className="mb-6">
        <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-mb">
            ...
            <div className="flex-1">
                ...
                <p className="text-gray-300 text-sm sm:text-base">
                    Um site institucional para divulgar os produtos da Eletronic Now, que permite aos visitantes encontrar uma peça eletrônica específica que variam em marca, modelo, uso e preço.
                </p>
            </div>
        </div>
    </div>
...
export default ResumeCardWork1;